...
A failed EXIF read no longer blocks the slideshow. The folder list refreshes on `getInterval`. Other modules (such as MMM-iCloudPhotos) can send `MMM_IMAGESPHOTOS_REFRESH` to reload immediately. 
